...
export const drawerNavigation: NavigationItem[] = [
  ...
  { label: "Help & contact", href: "/contact-us", icon: LifeBuoy },
  { label: "Common questions", href: "/faq", icon: CircleHelp },
  { label: "Return & refund policy", href: "/return-refund-policy", icon: RotateCcw },
  { label: "Delivery information", href: "/delivery-information", icon: Truck },
