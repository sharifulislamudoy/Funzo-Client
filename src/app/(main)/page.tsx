...
export default function HomePage() {
  return (
    <section className="relative isolate -mb-20 min-h-[100svh] overflow-hidden bg-[#141414] text-white lg:mb-0">
      <video
        aria-hidden="true"
        autoPlay
        loop
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] w-full max-w-7xl items-center px-4 pb-28 pt-32  sm:pb-32 sm:pt-36  lg:pb-20 lg:pt-40">
        <div className="max-w-3xl">
          ...
          <h1 className="max-w-4xl text-5xl md:text-7xl font-black  text-white ">
          ...
          <p className="mt-6 max-w-xl text-base font-medium leading-7 text-white/80 sm:text-lg sm:leading-8">
            High-speed RC drift cars, off-road machines and premium racing gear
            — tested for performance and delivered across Bangladesh.
          </p>
